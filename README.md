...
## 经典论文
### LLM领域
1、或许你曾经听过FLAN(finetune language net)，这篇论文是谷歌提出Instruction tuning的经典，文章将微调后的模型和175B的GPT-3进行了比较，证明了指令微调的优越性：
https://arxiv.org/pdf/2109.01652.pdf  Finetuned Language Models are Zero-Shot Learners
...
https://doi.org/10.48550/arXiv.2402.06094  Rethinking Data Selection for Supervised Fine-Tuning
