![image](https://github.com/GreenHornDong/Instruction-Tuning/assets/101792419/05c4b791-b08d-4809-92b2-f46a9e435185)![image](https://github.com/GreenHornDong/Instruction-Tuning/assets/101792419/5c0678ff-f85e-4d1f-b810-2afdda29d571)llava_v1_5_mix665K数据去重(0.7)：
| Dataset | Llava_665K | 原始图片数据 | 相似数据 | 过滤后数据 | 过滤百分比 |
| --- | --- | --- | --- | --- | --- |
